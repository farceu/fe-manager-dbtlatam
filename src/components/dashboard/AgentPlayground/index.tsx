...
export default function AgentPlayground() {
  const { form, onSubmit } = useAgentPlayground();
  ...
  return (
    <>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} id="agent-playground">
          ...
          <div className="hidden h-full flex-col md:flex">
            <div className="container flex flex-col items-start justify-between space-y-2 py-4 sm:flex-row sm:items-center sm:space-y-0 md:h-16">
              <h2 className="text-lg font-semibold w-full">Agent Playground</h2>
            ...
            <Tabs defaultValue="complete" className="flex-1">
              <div className="container h-full py-6">
                <div className="grid h-full items-stretch gap-6 md:grid-cols-[1fr_200px]">
                  <div className="hidden flex-col gap-4 space-y-4 sm:flex md:order-2">
                    <div className="grid gap-2">
                      <HoverCard openDelay={200}>
                        ...
                        <HoverCardContent className="w-[320px] text-sm" side="left">
                          Choose the tab you need to finish your agent.
                        </HoverCardContent>
                      </HoverCard>
                      <TabsList className="grid grid-cols-2">
                        <TabsTrigger value="complete">
                          <HoverCard openDelay={200}>
                            ...
                            <HoverCardContent className="w-[320px] text-sm" side="left">
                              Write the prompt for your agent.
                            </HoverCardContent>
                          </HoverCard>
                        ...
                        <TabsTrigger value="insert">
                          <HoverCard openDelay={200}>
                            ...
                            <HoverCardContent className="w-[320px] text-sm" side="left">
                              Choose the tools your agent will use.
                            </HoverCardContent>
                          </HoverCard>
                    ...
                    <LLMProviderSelect providers={lLMProviders} models={models} />
